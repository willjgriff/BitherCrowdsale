 ...
 *
 * Call with 'truffle --network [ropsten/mainnet] exec scripts/SubmitConfirmationsToMultiSig.js'
 */
module.exports = async function(callback) {
    ...
    const MULTISIG_OWNER = (await web3.eth.getAccounts())[0] // This should be account[0] provided the correct account has been imported into the web3 provider
