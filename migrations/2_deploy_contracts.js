...
module.exports = async (deployer, network, accounts) => {
  ...
  async function transferTokensToMultiSig () {
    ...
    const btrDecimal = await bitherToken.decimals();
    console.log('Transfering BTR Tokens to the MultiSig address: ' + MultiSigWallet.address);
    ...
    console.log('Transfering BSK Tokens to the MultiSig address: ' + MultiSigWallet.address);
